...
#   destFullPath: 
#  
def MetaToCoords(metaFullPath, outType: int, badChan= np.zeros((0), dtype = 'int'), destFullPath='', showPlot=False):
    ...
    if outType >= 0:
        ...
        print('Invalid outType specified; must be 0, 1, 2, 3, or 4')
        return
